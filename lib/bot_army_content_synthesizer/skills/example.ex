defmodule BotArmyContentSynthesizer.Skills.Example do
  @moduledoc """
  Example skill for Content Synthesizer Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_content_synthesizer.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_content_synthesizer.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_content_synthesizer/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_content_synthesizer.command.example"
    ]
  end

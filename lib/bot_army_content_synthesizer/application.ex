defmodule BotArmyContentSynthesizer.Application do
  @moduledoc """
  Content Synthesizer Bot application supervisor.
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: BotArmyContentSynthesizer.Supervisor]
  ...
  defp maybe_add_repo(children) do
    if @env == :test do
      ...
      [{BotArmyContentSynthesizer.Repo, []} | children]
    end
  end
  ...
  defp maybe_add_pulse_publisher(children) do
    if @env == :test do
      ...
      [{BotArmyContentSynthesizer.PulsePublisher, []} | children]
    end
  end

defmodule BotArmyContentSynthesizer.HTTPClient do
  @moduledoc """
  ...
  Pass http_client as an option in init:
      def init(opts) do
        http_client = Keyword.get(opts, :http_client, BotArmyContentSynthesizer.HTTPClient.Req)
...
defmodule BotArmyContentSynthesizer.HTTPClient.Req do
  ...
  @behaviour BotArmyContentSynthesizer.HTTPClient

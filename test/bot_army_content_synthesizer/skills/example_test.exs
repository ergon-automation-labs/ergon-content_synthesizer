defmodule BotArmyContentSynthesizer.Skills.ExampleTest do
  @moduledoc """
  ...
  alias BotArmyContentSynthesizer.Skills.Example
  ...
  describe "nats_triggers/0" do
    test "returns list of trigger subjects" do
      ...
      assert "bot.bot_army_content_synthesizer.command.example" in triggers
    end
  end
